...
```bash
curl -SSL https://raw.githubusercontent.com/Azure-Samples/media-services-video-indexer/bug/tshaiman/broken-link/VideoIndexerEnabledByArc/aks/vi_extension_install.sh
