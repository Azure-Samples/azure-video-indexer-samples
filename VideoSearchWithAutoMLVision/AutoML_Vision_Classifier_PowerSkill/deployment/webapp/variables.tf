...
variable "docker_image" {
  ...
  default     = "shanepeckham/amlclassifier:v1"
}
...
variable "vi_api_key" {
  description = "This is the API key for Video Indexer - update this after you create the VI account"
  default     = ""
}

variable "vi_account_id" {
  description = "This is the Account Id for Video Indexer - update this after you create the VI account"
  default     = ""
}
...
variable "vi_location" {
  description = "The region of the Video Indexer instance - update this after you create the VI account"
  default     = ""
}
